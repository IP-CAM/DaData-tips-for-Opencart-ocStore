                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="submit" class="btn btn-primary"
                                               formaction="<?php echo $url->link('module/suggest/installDefaultDemoData', 'token=' . $token, 'SSL'); ?>"
                                               name="demo_default" value="Обычный заказ\регистрация"/>
                                        <input type="submit" class="btn btn-warning"
                                               formaction="<?php echo $url->link('module/suggest/installSimpleDemoData', 'token=' . $token, 'SSL'); ?>"
