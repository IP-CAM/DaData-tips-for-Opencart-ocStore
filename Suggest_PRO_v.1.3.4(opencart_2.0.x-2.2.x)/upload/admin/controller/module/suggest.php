...
class ControllerModuleSuggest extends Controller
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('module/suggest', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('module/suggest.tpl', $data));
    ...
    public function installDefaultDemoData()
    {
        ...
        $this->response->redirect($this->url->link('module/suggest', 'token=' . $this->session->data['token'], 'SSL'));
